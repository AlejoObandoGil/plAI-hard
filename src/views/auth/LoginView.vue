<template>
  <main class="min-h-screen flex flex-col justify-center items-center px-4">
    <div class="w-full max-w-sm bg-accent-card rounded-2xl shadow-soft p-6 flex flex-col gap-6">
      <h2 class="text-2xl font-display text-center text-primary mb-2">Iniciar sesión</h2>
      ...
      >
        <svg class="w-5 h-5" viewBox="0 0 48 48">
          <g>
            <path
              fill="#4285F4"
              d="M24 9.5c3.54 0 6.7 1.22 9.19 3.23l6.85-6.85C36.09 2.97 30.47 0.5 24 0.5 14.61 0.5 6.44 6.44 2.69 14.35l7.98 6.2C12.14 14.38 17.58 9.5 24 9.5z"
            />
            <path
              fill="#34A853"
              d="M46.1 24.5c0-1.64-.15-3.22-.44-4.74H24v9.24h12.39c-.54 2.9-2.19 5.36-4.67 7.03l7.25 5.64C43.55 37.07 46.1 31.27 46.1 24.5z"
            />
            <path
              fill="#FBBC05"
              d="M10.67 28.55A14.48 14.48 0 019.5 24c0-1.57.27-3.1.75-4.55l-7.98-6.2A23.456 23.456 0 000 24c0 3.74.9 7.26 2.5 10.35l8.17-6.35z"
            />
            <path
              fill="#EA4335"
              d="M24 47.5c6.47 0 12.09-2.14 16.64-5.83l-7.25-5.64c-2.02 1.36-4.6 2.17-7.39 2.17-6.42 0-11.86-4.88-13.33-11.35l-8.17 6.35C6.44 41.56 14.61 47.5 24 47.5z"
            />
          </g>
        </svg>
      ...
      <div class="flex flex-col gap-2 mt-2 text-center">
        ...
        <span class="text-xs text-primary/70"
          >¿No tienes cuenta?
          <router-link to="/register" class="font-bold text-secondary hover:underline"
