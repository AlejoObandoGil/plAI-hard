<template>
  <nav class="fixed bottom-0 left-0 right-0 bg-accent-card text-accent md:hidden">
    <div class="flex justify-around items-center h-16">
      ...
      <router-link to="/exercises" class="flex flex-col items-center p-2" active-class="text-secondary">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
        </svg>
        <span class="text-xs mt-1">Ejercicios</span>
      </router-link>
      <router-link to="/my-routine" class="flex flex-col items-center p-2" active-class="text-secondary">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
