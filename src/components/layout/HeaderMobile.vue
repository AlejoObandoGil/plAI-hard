    ...
    <div class="flex justify-between items-center px-4">
      ...
      <div class="flex items-center space-x-2">
        <template v-if="!isAuthenticated">
          <button @click="goToLogin" class="flex items-center px-3 py-1 rounded-full bg-primary text-white hover:bg-primary-dark transition-colors">
        ...
        <template v-else>
          ...
          <button @click="$emit('open-sidebar')" class="w-10 h-10 rounded-full bg-secondary flex items-center justify-center">
